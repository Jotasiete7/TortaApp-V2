...
export const chartsTranslations: Translations = {
    ...
    'market_trends': { en: 'Market Trends', pt: 'TendÃªncias de Mercado' },
    'analyze_text': { en: 'Analyze price history and supply distribution per item.', pt: 'Analise histÃ³rico de preÃ§os e distribuiÃ§Ã£o de supply por item.' },
    ...
    'guide_intro_desc': { en: 'Your professional market intelligence platform.', pt: 'Sua plataforma profissional de inteligÃªncia de mercado.' },

    // Volatility
    'volatility': { en: 'Volatility', pt: 'Volatilidade' },
    'vol_score': { en: 'Volatility Score', pt: 'Score de Volatilidade' },
    'stable': { en: 'Stable', pt: 'EstÃ¡vel' },
    'moderate': { en: 'Moderate', pt: 'Moderada' },
    'volatile': { en: 'Volatile', pt: 'VolÃ¡til' },
    'rising': { en: 'Rising', pt: 'Subindo' },
    'falling': { en: 'Falling', pt: 'Caindo' },

    // Charts
    'line_chart': { en: 'Line Chart', pt: 'GrÃ¡fico de Linha' },
    'candlestick': { en: 'Candlestick', pt: 'Candlestick' },
    'heatmap': { en: 'Supply Heatmap', pt: 'Mapa de Calor' },
    'price_history': { en: 'Price History', pt: 'HistÃ³rico de PreÃ§os' },
    'supply_density': { en: 'Supply Density', pt: 'Densidade de Supply' },

    // Market Health
    'market_health': { en: 'Market Health', pt: 'SaÃºde do Mercado' },
    ...
    // Seller Insights
    'seller_insights': { en: 'Seller Insights', pt: 'AnÃ¡lise de Vendedores' },
    'top_sellers': { en: 'Top Sellers', pt: 'Top Vendedores' },
    'market_share': { en: 'Market Share', pt: 'Fatia de Mercado' },
    'activity_score': { en: 'Activity Score', pt: 'PontuaÃ§Ã£o de Atividade' },
    'concentration': { en: 'Concentration', pt: 'ConcentraÃ§Ã£o' },
    'strategy': { en: 'Strategy', pt: 'EstratÃ©gia' },

    // Prediction
    'price_forecast': { en: 'Price Forecast', pt: 'PrevisÃ£o de PreÃ§o' },
    'predicted': { en: 'Predicted', pt: 'Previsto' },
    'current': { en: 'Current', pt: 'Atual' },
    'confidence': { en: 'Confidence', pt: 'ConfianÃ§a' },
    'trend': { en: 'Trend', pt: 'TendÃªncia' },
    'forecast_disclaimer': { en: 'Predictions based on historical data.', pt: 'PrevisÃµes baseadas em dados histÃ³ricos.' },
    ...
    'cat_ores': { en: 'Ores', pt: 'MinÃ©rios' },
    'cat_clay': { en: 'Clay', pt: 'Argila' },
    'cat_other': { en: 'Other', pt: 'Outros' },
    // Forecast specific
    'data_points': { en: 'data points', pt: 'pontos de dados' },
    'weak_uptrend': { en: 'Weak Uptrend', pt: 'TendÃªncia de Alta Fraca' },
    'moderate_uptrend': { en: 'Moderate Uptrend', pt: 'TendÃªncia de Alta Moderada' },
    'strong_uptrend': { en: 'Strong Uptrend', pt: 'TendÃªncia de Alta Forte' },
    'weak_downtrend': { en: 'Weak Downtrend', pt: 'TendÃªncia de Baixa Fraca' },
    'moderate_downtrend': { en: 'Moderate Downtrend', pt: 'TendÃªncia de Baixa Moderada' },
    'strong_downtrend': { en: 'Strong Downtrend', pt: 'TendÃªncia de Baixa Forte' },
    'price_projection': { en: 'Price Projection (with 95% confidence interval)', pt: 'ProjeÃ§Ã£o de PreÃ§o (com intervalo de confianÃ§a de 95%)' },
    'predictions_disclaimer': { en: 'Predictions are based on historical data using linear regression. Actual prices may vary due to market events, game updates, or external factors.', pt: 'PrevisÃµes baseadas em dados histÃ³ricos usando regressÃ£o linear. PreÃ§os reais podem variar devido a eventos de mercado, atualizaÃ§Ãµes do jogo ou fatores externos.' },
    'not_enough_data': { en: 'Not enough data for prediction (minimum 5 data points required)', pt: 'Dados insuficientes para previsÃ£o (mÃ­nimo de 5 pontos necessÃ¡rios)' },
    'current_price': { en: 'Current Price', pt: 'PreÃ§o Atual' },
