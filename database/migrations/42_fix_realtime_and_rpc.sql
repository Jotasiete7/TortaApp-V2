-- 42_fix_realtime_and_rpc.sql
-- 1. Enable Realtime for 'profiles' table (where XP lives)
-- 2. Update get_player_stats_v3 to return user_id so frontend can subscribe to the correct row.
begin;
-- Enable Realtime
alter publication supabase_realtime
add table public.profiles;
-- Update RPC to include user_id
