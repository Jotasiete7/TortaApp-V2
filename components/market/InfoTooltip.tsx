...
export const InfoTooltip = ({ text }: { text: string }) => {
    return (
        <div className="group/tooltip relative inline-flex items-center ml-1">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-900 border border-slate-700 rounded shadow-xl text-[10px] text-slate-300 opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none z-50">
                {text}
